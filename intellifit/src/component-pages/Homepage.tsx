        ...
        <>
          ...
          <div className="one-item-card">
            ...
            {editSettings && <>
              ...
              style={{ alignItems: "center", justifyContent: "space-between", height: "50px", fontSize:"20px" }}
            >
              <p style={{ margin: "0px",fontSize:"18px" }}>Calorie Goal: </p>{" "}
            ...
            <div
              ...
              style={{ alignItems: "center", justifyContent: "space-between", height: "50px", fontSize:"20px" }}
            >
              <p style={{ margin: "0px",fontSize:"18px" }}>Protein Goal (grams): </p>{" "}
            ...
            <div
              ...
              style={{ alignItems: "center", justifyContent: "space-between", height: "50px", fontSize:"20px" }}
            >
              <p style={{ margin: "0px",fontSize:"18px" }}> Weight (kg): </p>{" "}
            ...
            {!editSettings && userData  && <>
              <div
              className="horizontal-flex"
              style={{ alignItems: "center", justifyContent: "space-between", height: "30px", fontSize:"20px" }}
            >
              <p style={{ margin: "0px" }}>Calorie Goal: </p>{" "}
              <span>
                {calorie ? calorie: "Not Set"}
              </span>
            </div>
            <div
              className="horizontal-flex"
            ...
            <button className="meal-option" onClick={() => {setEditSettings(true)}}>
              Edit
            </button>
            </>}
