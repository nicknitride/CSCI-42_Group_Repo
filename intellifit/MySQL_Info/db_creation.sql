...
CREATE TABLE workout_exercise_entry (
    workout_exercise_id INT AUTO_INCREMENT,
    workout_id INT,
    exercise_id INT,
...
CREATE TABLE workout_completed (
    workout_completed_id INT AUTO_INCREMENT,
    completed_date DATE,
    PRIMARY KEY (workout_completed_id)
);
CREATE TABLE exercise_completed (
    exercise_completed_id INT AUTO_INCREMENT,
    ...
    FOREIGN KEY (exercise_id) REFERENCES exercise(exercise_id),
    PRIMARY KEY (exercise_completed_id),
    CHECK
